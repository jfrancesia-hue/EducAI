...
**Tagline:** _"El sistema operativo de la escuela moderna."_
...
- **Mobile (alumnos + padres):** PWA instalable sobre Next.js
...
- **Mobile distribución:** instalación directa desde navegador (PWA)
